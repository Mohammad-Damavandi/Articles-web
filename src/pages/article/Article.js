...
function Article(){
    ...
    const deleteArticleHabdler = (articleId) => {


        Swal.fire({
            title: "مطمعنی میخوای مقاله رو حزف کنی؟",
            icon: "warning",
                ...
                <Col lg={4}>
                   <div className="articleCardContainer">
                     ...
                     <div className="cardFooter">
                        ...
                        <Button onClick={ () => deleteArticleHabdler(articleId)} variant = "outline-danger"><MdDelete size ='25px' /> حذف مقاله</Button>
